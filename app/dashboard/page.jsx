...
export default function Dashboard() {
    return (
        <div className={`main-content pt-[100px] mr-[10px] ml-[10px] transition-all duration-300 xl:w-[79%]  lg:w-[70%] float-end  `}>
                                        ...
                                        <div
                                            ...
                                            <div class="name">
                                                <a
                                                    ...
                                                    class="body-title-2 mb-3"
                                                >Pedigree Adult Dry Dog...</a
                                                >
                            ...
                            <ul class="flex flex-column justify-between gap10 h-full">
                                <li class="country-item">
                                    ...
                                    <div
                                        ...
                                        <a href="countries.html" class="body-text name"
                                        >Turkish Flag</a
                                        >
                                        <div class="box-icon-trending up">
                                            <i class="icon-trending-up"></i>
                            ...
                            <div class="wg-table table-best-shop-sellers">
                                ...
                                <ul class="flex flex-column gap18">
                                    <li class="shop-item">
                                        ...
                                        <div
                                            class="flex-grow flex items-center justify-between gap20">
                                            <div>
                                            ...
                                            <div
                                                class="flex items-center justify-between gap10">
                                ...
                                <ul class="flex flex-column gap10">
                                    ...
                                    <li class="product-item gap14">
                                        ...
                                        <div
                                            ...
                                            <div class="name">
                                                <a href="product-list.html" class="body-text"
                                                >Taste of the Wild Formula Finder</a
                                                >
                                            </div>
                            ...
                            <div class="wg-table table-orders">
                                ...
                                <ul class="flex flex-column gap18">
                                    <li class="product-item gap14">
                                        ...
                                        <div
                                            class="flex items-center justify-between flex-grow gap10">
                                            <div class="name">
                                                <a href="product-list.html" class="body-text"
                                                >Prodotti per il tuo cane...</a
                                                >
                                            </div>
                        ...
                        <div class="wg-box">
                            ...
                            <ul class="flex flex-column gap20 overflow-h">
                                <li class="comment-item">
                                    ...
                                    <div class="">
                                        <div class="mb-4 name">
                                            <a href="all-user.html" class="body-title-2"
                                            >Kathryn Murphy</a
                                            >
                                        </div>
                                ...
                                <li class="comment-item">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="text-tiny">
                                            Morbi eget commodo diam. Praesent dignissim purus
                                            ac turpis porta
                                        </div>
                                    </div>
                                </li>
                                <li class="comment-item">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="text-tiny">
                                            ...
                                            eget, pharetra ante. Sed blandit risus vitae dolor
                                            feugiat, eu vulputate elit rhoncus
                                        </div>
                                    </div>
                                </li>
                                <li class="comment-item">
