...
const FormStepOne = ({ formData, handleInputChange, nextStep }) => (
    <>
        ...
        <div className="flex justify-end space-x-4 mt-4">
            <button onClick={nextStep} className="py-3 px-5 text-2xl bg-blue-600 text-white font-bold rounded-2xl">
                Next
            </button>
        </div>
    </>
...
const FormStepTwo = ({ formData, handleInputChange, handleFileChange, handleRegister, showPassword, toggleShowPassword, loading, previousStep }) => (
    <div>
        ...
        <div className="flex justify-between space-x-4 mt-5">
            <button onClick={previousStep} className="py-3 px-5 text-2xl bg-gray-500 text-white font-bold rounded-2xl">
                Back
            </button>
            <button
                onClick={handleRegister}
                disabled={loading}
                className="py-3 px-5 bg-blue-600 text-2xl text-white font-bold rounded-2xl"
            >
...
export default function Register() {
    ...
    return (
        <div className="flex min-h-screen xl:overflow-y-hidden bg-gray-100 justify-between relative">
            ...
            <div className="flex flex-col justify-center items-center xl:w-1/2 lg:w-1/2 md:w-1/2 w-fit  md:px-0 shadow-md py-2 shadow-gray-200 bg-white h-[100vh]   ">
